@echo off
rem cardforge web launcher: uses configured venv (settings.json "venv"), fallback to project .venv, auto-bootstraps on first run
setlocal
set "ROOT=%~dp0"
set "VENV_DIR="
...
"%VENV_DIR%\Scripts\python.exe" "%ROOT%webapp.py" %*
if errorlevel 1 (
    echo.
